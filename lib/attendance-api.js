...
const ATTENDANCE_ORIGIN = process.env.WTS_ATTENDANCE_ORIGIN || "https://wts-attendance-system.vercel.app";
const PORTAL_ORIGIN = process.env.WTS_PORTAL_ORIGIN || "https://wts-school-platform.vercel.app";
const ATTENDANCE_REDIRECT_URI = `${ATTENDANCE_ORIGIN.replace(/\/$/, "")}/`;
const ATTENDANCE_POST_LOGOUT_URI = `${PORTAL_ORIGIN.replace(/\/$/, "")}/workspace`;
