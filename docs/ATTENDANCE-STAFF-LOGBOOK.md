...
QR, manual and imported terminal events use the same staff daily interpretation. A missing departure remains incomplete rather than being silently counted as a complete day.
